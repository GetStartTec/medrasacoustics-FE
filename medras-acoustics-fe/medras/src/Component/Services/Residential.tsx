...
export const Residential = () => {
    ...
    const sections = [
        { title: "Home Theater Acoustics", image: "/images/home-theater.png", description: "Perfect Home Theater isn’t just about a big screen—it’s about immersive sound that makes every movie come alive. Proper acoustics ensure clear dialogue, deep bass, and an immersive surround sound experience. Room Design & Layout – Optimize speaker placement and seating for the best sound distribution. " },
        ...
        { title: "Basement Soundproofing",  image: "/images/basement.png", description: "Transform your basement into a quiet retreat by blocking out unwanted noise from the rest of the house or preventing sound from escaping. Whether it's a home theater, music studio, gym, or office, proper soundproofing ensures privacy and comfort. Noise-Blocking Doors & Windows  – Install solid-core doors and weather stripping for better isolation." },
